...
$(".dropdown-item").click(function (e) {
  ...
  document.querySelector(".video-container").innerHTML = iframes[randomNumber()];
...
async function validateQuizP1() {
  ...
  request.ok ? showAlert("success","Your test result has been sent to your teacher 😉.","4000")  : showAlert("danger", "There was an error", "4000");
